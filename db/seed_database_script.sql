...
INSERT INTO customers (last_name, first_name, dob, email, phone, address) VALUES ("Smith", "John", "2000-03-14", "johnsmith@gmail.com", "07777123123", "123 First Street, Anytown, Somecounty, AB12 3CD"), ("Doe", "Jane", "1998-06-23", "janedoe@yahoo.com", "07555987654", "456 Second Street, Here, There, CD32 1AB");
INSERT INTO accounts (account_num, sort_code, type_id, status, balance, creation_date, customer_id) VALUES ("12345678", "11-22-33", 1, "Open", 1000.00, CURDATE(), 1), ("98765432", "44-55-66", 1, "Open", 1345.54, CURDATE(), 2);
